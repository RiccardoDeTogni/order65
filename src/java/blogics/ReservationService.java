...
public class ReservationService {
    ...
    public static Reservation insertReservation(Database db, Date data, Time ora_inizio, Time ora_fine, long id_campo, long id_user, boolean aperta, int num_partecipanti) throws SQLException, NotFoundDBException, ResultSetDBException, DuplicatedRecordDBException {
        Reservation reserv = null;
        try {
            reserv = new Reservation(data, ora_inizio, ora_fine, id_campo, aperta, num_partecipanti, id_user);
    ...
    public static void makeCampoUnavailable(Database db, Date d, Time init_time, Time end_time, long id_campo, long id_user) throws SQLException, NotFoundDBException, ResultSetDBException, DuplicatedRecordDBException {
        Time inc = init_time;
