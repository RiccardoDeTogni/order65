        ...
        $(this).each(function(i, elem){
            ...
            form.submit(function(){
                var msg; function successCallback(resp){
                    ...
                    else{email.removeClass("valid").addClass("error"); 
                ...
                $.ajax({url:url, data:data, success:successCallback, dataType:"jsonp", 
                ...
                if (settings.language !== "en" && 
                    ...
                    submitMsg = $.ajaxChimp.translations[settings.language]["submit"]}label.html(submitMsg).show(2e3); 
                return false})}); 
        return this}})(jQuery);